...
// It will be called inside the successful login block to prevent unnecessary session startup
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($conn->connect_error) {
            ...
            // =========================================================================
            // ✅ MODIFICATION: Select user_id, first_name, last_name, and password_hash
            // =========================================================================
            ...
            if ($stmt === false) {
                ...
                // =========================================================================
                // ✅ MODIFICATION: Bind result variables for the new fields
                // =========================================================================
                ...
                if ($stmt->num_rows === 1) {
                    ...
                    if (password_verify($password, $hashed_password)) {
                        ...
                        // =========================================================================
                        // ✅ MODIFICATION: Store user details in session for homepage.php access
                        // =========================================================================
